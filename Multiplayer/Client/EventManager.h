...
public:
    ...
    public:
        ...
        Event(int type, int id, int priority, EventManager* manager, zmq::socket_t* socket, char* clientId);
        int getId();
        int getPriority();
    ...
    public:
        DeathEvent();
        DeathEvent(int id, int priority, Character* player, EventManager* manager, zmq::socket_t* socket, char* clientId);
        void Death();
    };
    ...
    EventManager(Timeline* timeline, zmq::socket_t* socket, char* id);
    //registration
